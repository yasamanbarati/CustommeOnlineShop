...
const symbolsImage = ["/images/01.png", "/images/02.png", "/images/03 1.png"];

const FooterBox = styled(Box)(({ theme }: any) => ({
  marginTop: "30px",
  width: "100%",
...
const LogoBoxLink = styled(Link)(({ theme }: any) => ({
  fontSize: "1.5rem",
  lineHeight: "140%",
  fontWeight: "800",
  whiteSpace: "nowrap",
...
const TrustSiteSection = styled("div")(({ theme }: any) => ({
  display: "flex",
  justifyContent: "space-between",
  alignItems: "center",
  borderTop: `1px solid ${theme.palette.primary.light}`,
...
const TrustSiteArticle = styled("div")(() => ({
  position: "relative",
  marginLeft: "40px",
  overflow: "hidden",
  height: "125px",
...
const SymbolImage = styled("img")(({ theme }: any) => ({
  width: "100px",
  height: "100px",
  padding: "16px",
        ...
        <FooterContentBox>
          ...
          >
            ...
            <div style={{ display: "flex" }}>
              <Typography variant="body2" component="p" ml={4}>
                تماس با پشتیبانی : 021-3456000
              </Typography>
              <Typography variant="body2" component="p" ml={4}>
        ...
        <TrustSiteSection>
          <TrustSiteArticle>
            <Typography component="h1" variant="h5" mb={4}>
              فروشگاه اینترنتی کاستومی، بررسی، انتخاب و خرید آنلاین
            </Typography>
            <Typography component="p" variant="body1">
              ...
              که فروشگاه اینترنتی کاستومی سال‌هاست بر روی آن‌ها کار کرده و
              توانسته از این طریق مشتریان ثابت خود را داشته باشد. یکی از
              مهم‌ترین دغدغه‌های کاربران کاستومی یا هر فروشگاه‌ اینترنتی دیگری،
              این است که کالای خریداری شده چه زمانی به دستشان می‌رسد. کاستومی
              ...
              گاهی برای کاربران جدید، مبهم و پیچیده به نظر برسند. برای آگاهی
              بیشتر مشتریان از خدمات کاستومی، این فروشگاه اینترنتی در بخشی از
              وب‌سایت خود راهنمای کاملی از شیوه‌‌های ارسال را به صورت ساده و به
              دور از پیچیدگی، قرار داده است که شامل 8 نوع ارسال کالا به روش‌های
              زیر است: ارسال امروز، دریافت حضوری، دریافت از گنجه، ارسال توسط
